describe("calculateOrderTotal", () => {
  ...
  it("Panier vide → erreur", () => {
    expect(() =>
      calculateOrderTotal([], 5, 1, null, 15, 2, promoCodes),
    ).toThrow();
  });
...
describe("applyPromoCode", () => {
  ...
  it("applique un code percentage 20% sur 50€", () => {
    expect(applyPromoCode(50, "BIENVENUE20", promoCodes, "2026-04-07")).toBe(
      40,
    );
  });
  ...
  it("erreur si code inconnu", () => {
    expect(() =>
      applyPromoCode(30, "INCONNU", promoCodes, "2026-04-07"),
    ).toThrow();
  });
  ...
  it("subtotal négatif → erreur", () => {
    expect(() =>
      applyPromoCode(-10, "FIXE5", promoCodes, "2026-04-07"),
    ).toThrow();
  });
...
describe("calculateDeliveryFee", () => {
  ...
  it("should return 2.00 for 1km, 1kg", () => {
    expect(calculateDeliveryFee(1, 1)).toBe(2.0);
  });
  ...
  it("should return 4.50 for 5.0km, 5.1kg", () => {
    ...
    expect(calculateDeliveryFee(5, 5.1)).toBe(4.5);
  });
  ...
  it("should return 4.50 for 5km, 6kg", () => {
    expect(calculateDeliveryFee(5, 6)).toBe(4.5);
  });
  it("should return 2.00 for 0km, 0kg", () => {
    expect(calculateDeliveryFee(0, 0)).toBe(2.0);
  });
});
describe("calculateDiscount", () => {
  ...
  it("should handle buyXgetY", () => {
    const rules = [{ type: "buyXgetY", buy: 3, free: 1, itemPrice: 10 }];
...
describe("groupBy", () => {
  ...
  it("should handle missing key", () => {
    const arr = [{ name: "Alice", role: "dev" }, { name: "Bob" }];
...
describe("clamp", () => {
  ...
  it("should throw for negative price", () => {
    expect(() =>
      calculateDiscount(-10, [{ type: "fixed", value: 5 }]),
    ).toThrow();
  });
  it("should throw for missing rule fields", () => {
    expect(() =>
      calculateDiscount(100, [{ type: "buyXgetY", buy: 3 }]),
    ).toThrow();
  });
